...
```
● 4.0.3: 优化图片编辑体验，记录之前编辑状态; 添加是否允许拍照参数; 优化降序照片获取顺序; fix [#510](https://github.com/longitachi/ZLPhotoBrowser/issues/510), fix [#513](https://github.com/longitachi/ZLPhotoBrowser/issues/513); 修复其他已知bug;
